---
title: "Autogenerate a Quarto publications listing from Excel (xlsx → YAML → custom listing)"
description-meta: "Convert publications.xlsx with xlsx_to_yml.py into publications.yml, then render a filterable publications page in Quarto using custom EJS and CSS."
author: "Gang He"
date: "2026-04-10"
