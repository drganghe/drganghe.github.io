...
| Project | <https://madeinamerica.netlify.app/> | <https://github.com/drganghe/quarto-academic-website-template> |
...
To make the badges display in the same line, you can add the following CSS to your `custom.css` file and include it in the yaml header of your qmd file.
...
![Highly cited paper](https://drganghe.github.io/files/images/highly-cited-paper-badge.png "ESI Highly Cited Paper") ![Hot paper](https://drganghe.github.io/files/images/hot-paper-badge.png "ESI Hot Paper")
...
Here is an [example](https://drganghe.github.io/quarto-academic-website-template/publications.html), and the [source code](https://github.com/drganghe/quarto-academic-website-template/blob/main/publications.qmd).
...
Read more detailed notes [here](notes/generate-publications-listing.llms.md).
