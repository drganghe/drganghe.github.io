...
This “R” scenario is shown in [Figure 1](#fig-electricity-generation-by-fuel), in the second column on the right-hand side, with wind (green) and solar (yellow) providing 39% of the total. As a result of higher non-fossil output, coal-based generation (black) could be just 3,700TWh in 2030 under the R scenario, some 30% lower than under BAU (4,900TWh). Battery storage (orange) and small amounts of gas (purple) generation would supplement the increasing wind and solar supplies.

![](electricity-generation-by-fuel.jpeg)

Figure 1: Electricity generation by fuel, terawatt hours, in 2020 (left), 2025 (centre) and 2030 (right), under each of the four modelled scenarios. Source: He et al. ([2020](#ref-he_rapid_2020)).

## Wind, solar and storage growth

Non-fossil sources of electricity would need to grow their capacity dramatically over the next decade if they are to meet such significant shares of electricity demand in China. [Figure 2](#fig-mix-of-installed-power-capacity) shows the capacity of each source, in gigawatts (GW), under the four scenarios.
...
![](mix-of-installed-power-capacity.jpeg)

Figure 2: Mix of installed power capacity, gigawatts, in each of the four scenarios in 2020 (left), 2025 (centre), and 2030 (right). Source: He et al. ([2020](#ref-he_rapid_2020)).
...
By 2030, storage capacity – including from batteries – is just 34GW under BAU, but needs to grow to as much as 307GW in the R scenario, as shown in orange in [Figure 2](#fig-mix-of-installed-power-capacity) above.
...
This is shown in the left-hand chart in [Figure 3](#fig-co2-and-power-costs), where power-sector CO2 emissions would be expected to remain relatively constant under BAU (blue line), but would fall rapidly over the next decade under the “R” low-cost renewables pathway (orange).

![](co2-and-power-costs.jpeg)

Figure 3: Power-sector CO2 emissions 2015-2030 (a, left, millions of tonnes) and electricity generation costs, including the cost of storage and other grid infrastructure (b, right, dollars per megawatt hour) under the four scenarios. Source: He et al. ([2020](#ref-he_rapid_2020)).

Given the remarkable and ongoing reductions in the cost of renewable power, the 25% reduction in carbon emissions could be achieved for a lower cost of power under the R scenario than under the BAU scenario, as shown in [Figure 3](#fig-co2-and-power-costs) right.
...
Check the original post at [Carbon Brief](https://www.carbonbrief.org/guest-post-chinas-power-sector-could-be-10-per-cent-cheaper-in-2030-with-more-renewables). Read more about our [paper](../../posts/2020-05-ncomms-rapid-re-cost/index.llms.md).
