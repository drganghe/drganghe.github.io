...
I teach energy systems, energy and climate policy, energy innovations, and methods. Here I list courses where I have started to open-source teaching materials.
...
“All models are wrong, but some are useful”. This class offers a systems approach and introduces useful modeling tools and skill sets to capture and reveal the grand challenges and opportunities of energy systems. The scope of this class includes an energy systems overview, making sense of energy numbers, energy project economics, energy sources and technologies, energy demand, energy, environment, and human health, energy and climate change, power system analysis, energy transition, energy efficiency, behavior, and sustainable consumption, energy poverty, access, and justice, big data and AI for clean energy, limitations of models, and other emerging topics for energy systems to achieve carbon neutrality.
...
[Spring 2023](https://sites.google.com/view/ganghe/teaching/EST625-2023-Advanced-Science-Technology-and-Innovation-Policy)   \|   [Spring 2022](https://sites.google.com/view/ganghe/teaching/EST625-2022-Advanced-Science-Technology-and-Innovation-Policy)
